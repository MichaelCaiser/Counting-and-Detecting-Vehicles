 ...
 * applying a XOR with a key. This key must be the same of the decoder, if it isn't the decoder can
 * not decode the information.<p>
 *
...
/**
 * This method generates a string that represents the current date in a specific format. The format is the
 * following: (month-day-year hour-minute-second).<p>
 *
...
string TokenBuilder::getCurrentDate()
{
	...
	//Warning this pointer is statically allocated, it mustn't be deleted
