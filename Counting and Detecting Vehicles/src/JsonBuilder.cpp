 ...
 * @Descrition
 * 		Metodo encargado de convertir objeto del tipo Reporte a un string que
 * 		representa a dicho objeto segun el estandar JSON.
 */
 ...
 * - string (string en formato JSON del objeto)
 * @Descrition
 * 		Metodo encargado de convertir objeto del tipo RegistroVehiculo a un string que
 * 		representa a dicho objeto segun el estandar JSON.
 */
 ...
 * @Descrition
 * 		Metodo encargado de convertir un valor float en un string cuyo formato sea el
 * 		establecido por JSON para valores de punto de flotante.
 */
 ...
 * @Descrition
 * 		Metodo encargado de convertir un valor entero en un string cuyo formato sea el
 * 		establecido por JSON para Int.
 */
 ...
 * @Descrition
 * 		Metodo encargado de convertir un string en otro string pero con el formato
 * 		JSON.
 */
 ...
 * @Descrition
 * 		Metodo encargado de convertir un time_t (Fecha) en un timestamp establecido por
 * 		el estandar de JSON.
 */
